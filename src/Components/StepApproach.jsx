        ...
        <div className="mx-auto w-full max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8">
          <motion.div variants={headerVariants} className="mb-8 sm:mb-10 md:mb-12 text-center">
            ...
            <motion.h2 
              ...
              viewport={{ once: false }}
              className="mt-6 sm:mt-8 text-2xl sm:text-3xl md:text-4xl lg:text-4xl font-semibold"
            >
              A Proven 4-Step Approach
              <br />
              to <motion.span 
            ...
            <motion.p 
              ...
              viewport={{ once: false }}
              className="mt-3 mx-auto max-w-2xl text-sm sm:text-base md:text-base lg:text-lg text-[#767676]"
            >
              A structured methodology designed to deliver measurable
              <br />
              results in weeks — not years.
            ...
            {steps.map((step, idx) => {
              ...
              return (
                <motion.div
                  ...
                  whileHover={{ scale: 1.02, boxShadow: "0 20px 40px rgba(18, 58, 189, 0.15)" }}
                ...
                >
                  ...
                  >
                    <motion.div 
                      ...
                      viewport={{ once: false }}
                    >
                      <span className="text-sm sm:text-base md:text-lg font-semibold text-[#123ABD]">
                        {step.number}
                      </span>
                      <motion.span 
