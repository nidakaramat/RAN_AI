...
const Footer = ({ variant }) => {
  return (
    <div className="bg-[#F0F4FF] w-full py-10">
      <motion.div
        ...
        {variant !== "contact" && (
          ...
          >
            ...
            <motion.img
              src={heroImage}
              alt="AI cube"
              className="absolute inset-0 w-full h-full object-contain sm:object-contain lg:object-contain xl:object-contain object-center"
              initial={{ scale: 1 }}
              whileInView={{ scale: 1 }}
              transition={{ duration: 0.8 }}
              viewport={{ once: false }}
            ...
            <motion.div
              ...
              viewport={{ once: false }}
              className="relative flex flex-col  h-full gap-4 sm:gap-6 max-w-7xl mx-auto"
              style={{ fontFamily: "DM Sans, sans-serif" }}
            >
              <h3 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl xl:text-[35px] mt-8 font-semibold">
                AI That Fits Your
                <br />
                Industry
              </h3>
              <p className="text-sm sm:text-base md:text-lg lg:text-xl xl:text-[17px] text-white">
              ...
              <div className=" items-center">
                <motion.button className="rounded-full bg-[#000000] px-5 sm:px-6 py-2.5 text-sm font-semibold text-white mt-4 lg:mt-4 xl:mt-6 ">
                  Talk to Our Team
                </motion.button>
              </div>
            </motion.div>
