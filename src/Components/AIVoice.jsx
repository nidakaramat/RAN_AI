    ...
    >
      <div className="mx-auto w-full max-w-6xl px-3 sm:px-4 md:px-6 lg:px-8 text-center">
        ...
        <motion.h2 
          ...
          viewport={{ once: false }}
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl mt-6 sm:mt-7 md:mt-8 font-semibold tracking-tight text-slate-900"
        >
          Looking for <motion.span 
        ...
        <motion.p 
          ...
          viewport={{ once: false }}
          className="mx-auto mt-3 sm:mt-4 md:mt-4 max-w-2xl text-xs sm:text-sm md:text-base lg:text-lg text-[#767676]"
        >
        ...
        <motion.div 
          ...
          viewport={{ once: false }}
          className="mt-7 sm:mt-8 md:mt-10 grid grid-cols-1 gap-4 sm:gap-5 md:gap-5 lg:gap-6 sm:grid-cols-2 lg:grid-cols-4"
        >
        ...
        >
          <motion.a
            href="#"
            whileHover={{ scale: 1.08, boxShadow: "0 15px 35px rgba(16, 2, 2, 0.4)" }}
            whileTap={{ scale: 0.95 }}
            animate={{ y: [0, -3, 0] }}
