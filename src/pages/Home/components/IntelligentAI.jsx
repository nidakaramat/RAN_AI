  ...
  return (
    ...
    >
      ...
      <motion.div
        ...
        variants={container}
        className="mx-auto w-full max-w-7xl px-3 sm:px-4 md:px-6 lg:px-5"
      >
        {/* Header */}
        <motion.div
          variants={item}
        ...
        >
          ...
          <motion.h2
            ...
            viewport={{ once: false }}
            className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-medium text-slate-900 mt-5"
            style={{
              fontFamily: "Geist, sans-serif",
              animation: "headingSlide 0.8s ease 0.3s both",
            }}
          >
            Intelligent <span className="text-[#121ABD]">AI Services</span>
          </motion.h2>
          <motion.p
            ...
            viewport={{ once: false }}
            className="max-w-2xl text-lg sm:text-xl md:text-2xl lg:text-6xl font-medium text-slate-900"
            style={{
              fontFamily: "Geist, sans-serif",
              animation: "headingSlide 0.8s ease 0.3s both",
            }}
